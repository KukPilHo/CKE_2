...
1. 줄 수 일치: 입력된 텍스트의 줄 수와 출력하는 번역문의 줄 수는 반드시, 예외 없이, 완벽하게 동일해야 한다. 입력이 21줄이면, 번역도 정확히 21줄이어야 한다. 줄을 합치거나 나누는 것은 절대 금지된다.
2. 어미 통일 (CRITICAL): 모든 번역은 평서체(해라체)로만 작성한다. "~이다", "~다", "~한다"를 사용하고, "~입니다", "~습니다", "~합니다" 등의 합쇼체는 어떤 경우에도 사용하지 않는다. 이것은 예외가 없는 절대 규칙이다.`,
